...
public static class GenericHelper
{
    ...
    /// <param name="barcode"></param>
    /// <returns></returns>
    public static string ToProcessLogHeader(   this ProcessTypeEnum rocessesType,  string serviceName, CommunicationEnum communication, int lane = 0, long id = 0, string barcode = "") =>
    ...
    public static string TimeSpanToString(this TimeSpan duration)
    {
        ...
        var str =  $"{(days > 0 ? $"{days}天" : "")}{(hours > 0 ? $"{hours}小时" : "")}{(minutes > 0 ? $"{minutes}分" : "")}{(seconds > 0 ? $"{seconds}秒" : "")}";
