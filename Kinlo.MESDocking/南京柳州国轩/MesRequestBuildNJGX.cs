...
public class MesRequestBuildNJGX
{
    ...
    public record ArgsActiveShutdown(int status, string guid,string warningType, DateTime startTime, DateTime? endTime,string responseTime ) : IMesArgs;
    ...
    public record ArgsPassiveShutdown(
       ...
       string warningCode,
       DateTime startTime,
       DateTime? endTime,  int? responseTime ) : IMesArgs;
