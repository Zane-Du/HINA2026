...
{
    public object GetPropertyValue(  Type propertyType, byte[] bytes,  ref double numBytes, ref int count,  CommunicationEnum endianTypes = CommunicationEnum.FinsTcp)
    {
        object? value = null;
    ...
    public double SetBytesFromProperty(object propertyValue, byte[] bytes,double numBytes, ref int count, CommunicationEnum endianTypes = CommunicationEnum.FinsTcp )
    {
        int bytePos = 0;
        int bitPos = 0;
        byte[]? bytes2 = null;
